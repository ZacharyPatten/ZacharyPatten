...
> Your repository's description is often the first text from your repository that people will see since it appears on repositories in most searching and exploring views on GitHub. Having an concise yet informative description will help you grab the attention of users that may be interested in your repository. However, if you have issues labeled `good first issue` or `help wanted`, GitHub often shows those issues instead of your description as a way to encourage potential contributors to give your repository a look.
>
...
<summary>
Do you have<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>Issues templates</code>,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;a <code>.github/ISSUE_TEMPLATE/config.yml</code>,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;and a <code>.github/pull_request_template.md</code>?
</summary>
<p>
